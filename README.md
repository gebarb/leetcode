...
- [x] 9. [Palindrome Number](https://github.com/gebarb/leetcode/blob/master/problems/palindrome_number.ts)
...
- [x] 27. [Remove Element](https://github.com/gebarb/leetcode/blob/master/problems/remove_element.ts)
...
- [x] 143. [Reorder List](https://github.com/gebarb/leetcode/blob/master/problems/reorder_list.js.ts)
...
- [x] 151. [Reverse Words in a String](https://github.com/gebarb/leetcode/blob/master/problems/reverse_words_in_string.ts)
...
- [x] 238. [Product of Array Except Self](https://github.com/gebarb/leetcode/blob/master/problems/array_product_except_self.ts)
...
- [x] 287. [Find the Duplicate Number](https://github.com/gebarb/leetcode/blob/master/problems/find_dupe.ts)
...
- [x] 338. [Counting Bits](https://github.com/gebarb/leetcode/blob/master/problems/counting_bits.ts)
...
- [x] 389. [Find the Difference](https://github.com/gebarb/leetcode/blob/master/problems/find_diff.ts)
...
- [x] 404. [Sum of Left Leaves](https://github.com/gebarb/leetcode/blob/master/problems/sum_left_leaves.java)
...
- [x] 442. [Find All Duplicates in an Array](https://github.com/gebarb/leetcode/blob/master/problems/find_all_dupes.ts)
...
- [x] 605. [Can Place Flowers](https://github.com/gebarb/leetcode/blob/master/problems/place_flowers.ts)
...
- [x] 643. [Maximum Average Subarray I](https://github.com/gebarb/leetcode/blob/master/problems/max_avg_subarray_1.ts)
...
- [x] 709. [To Lower Case](https://github.com/gebarb/leetcode/blob/master/problems/to_lower.ts)
...
- [x] 953. [Verifying an Alien Dictionary](https://github.com/gebarb/leetcode/blob/master/problems/alien_dict.java)
...
- [x] 1071. [Greatest Common Divisor of Strings](https://github.com/gebarb/leetcode/blob/master/problems/gcd_string.ts)
...
- [x] 1290. [Convert Binary Number in a Linked List to Integer](https://github.com/gebarb/leetcode/blob/master/problems/binary_to_int_ll.java)
- [x] 1306. [Jump Game III](https://github.com/gebarb/leetcode/blob/master/problems/jump_game_3.ts)
- [x] 1309. [Decrypt String from Alphabet to Integer Mapping](https://github.com/gebarb/leetcode/blob/master/problems/decrypt_alph_to_int.java)
...
- [x] 1356. [Sort Integers by The Number of 1 Bits](https://github.com/gebarb/leetcode/blob/master/problems/sort_int_by_bits.ts)
...
- [x] 1431. [Kids With the Greatest Number of Candies](https://github.com/gebarb/leetcode/blob/master/problems/kids_candies.sql)
...
- [x] 1678. [Goal Parser Interpretation](https://github.com/gebarb/leetcode/blob/master/problems/goal_parser.java)
...
- [x] 1768. [Merge Strings Alternately](https://github.com/gebarb/leetcode/blob/master/problems/merge_alternate.java)
